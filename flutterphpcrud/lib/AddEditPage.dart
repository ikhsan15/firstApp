...
import 'package:flutterphpcrud/main.dart';
...
class _AddEditPageState extends State<AddEditPage> {
  ...
  addUpdateData() {
    if (editMode) {
      var url = 'http://200.10.11.112/php-mysql-flutter-crud/edit.php';
      http.post(url, body: {
      ...
      var url = 'http://200.10.11.112/php-mysql-flutter-crud/add.php';
      http.post(url, body: {
        'firstname': firstName.text,
        'lastname': lastName.text,
        'phone': phone.text,
